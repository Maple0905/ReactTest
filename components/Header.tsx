export default function Header() {
	return (
		<div className="flex w-full items-center justify-between px-12 py-3 bg-gray-100">
			<div className="flex items-center text-md">
				<p className="font-semibold">Call Us:</p>
				<p className="pl-2">000 111 333</p>
				<p className="font-semibold pl-20">Send an Email:</p>
				<p className="pl-2">solarworld@gmail.com</p>
			</div>
			<div className="flex items-center text-md">
				<div className="flex items-center">
					...
					<p className="font-semibold pl-1">Location On Map</p>
				</div>
				<div className="flex items-center pl-10">
					...
					<p className="font-semibold pl-1">Working Hours</p>
				</div>
			</div>
		</div>
	)
